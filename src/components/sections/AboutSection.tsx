  ...
  return (
    <section className="py-16 bg-resort-white">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl md:text-4xl font-bold font-playfair mb-3 text-center">About MR Drivers</h2>
        <div className="w-20 h-1 bg-primary mx-auto mb-10"></div>
        
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          <div>
            <p className="mb-4 text-resort-navy/80">
              With over a decade of experience, MR Drivers has established itself as a premier transportation service provider across Australia. We pride ourselves on punctuality, professionalism, and personalized service.
            </p>
          ...
          <div className="flex justify-center">
            <div className="rounded-lg overflow-hidden shadow-lg w-full max-w-md">
              <img 
                src="public/lovable-uploads/7b2e42d9-14a9-49fb-ac3e-8e518efea6de.png" 
