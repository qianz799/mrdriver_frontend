        ...
        <div className="max-w-4xl mx-auto prose prose-lg">
          <div className="mb-8">
            ...
            <p className="text-resort-navy/80 leading-relaxed">
              MrDrivers ("we," "us," "our") is committed to protecting your privacy while providing luxury chauffeur services in Sydney, Australia, using our premium Mercedes-Benz fleet: Maybach S680 (3 passengers), Maybach GLS600 (3 passengers), S-Class (3 passengers), V-Class (6 passengers), GLS (4 passengers), custom VIP Sprinter (9 passengers, 10 seats including driver), and 11-14 PAX Sprinter (11-14 passengers). This Privacy Policy explains how we collect, use, and disclose your personal information in accordance with the Privacy Act 1988 (Cth) and the Australian Privacy Principles (APPs). By accessing our website (www.mrdrivers.com.au) or using our services, you agree to the collection and use of your personal information as described below. For more information on the Privacy Act, visit www.oaic.gov.au.
            </p>
          </div>
